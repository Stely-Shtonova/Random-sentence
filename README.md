...
In the end one ore more random sentences are displayed on the screen. They can be either questions or normal- simple sentences with either one or more subjects.
